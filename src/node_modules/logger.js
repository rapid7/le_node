...
const $retryTimeout      = Symbol('retryTimeout property');
...
export default class Logger extends Writable {
	constructor(opts) {
		...
		this[$maxFailedAttempts] = opts.maxFailedAttempts || defaults.maxFailedAttempts
		this[$retryTimeout]      = opts.retryTimeout || defaults.retryTimeout
	...
	@nonConfigurable
	get maxFailedAttempts() { return this[$maxFailedAttempts]; }
