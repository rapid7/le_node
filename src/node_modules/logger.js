...
const $bufferWasFull            = Symbol('bufferFull property');
const $bufferSize               = Symbol('bufferSize property');
...
export default class Logger extends Writable {
	...
	log(lvl, log) {
		...
		// if RingBuffer.write returns false, don't create any other write request for the writable stream to avoid memory leak
		// this means there are already 'bufferSize' of write events in the writable stream and that's what we want.
		...
		this[$connection] = new Promise((resolve, reject) => {
			...
			this[$reconnection].on('connect', (connection) => {
				...
				connection.on('timeout', () => {
					...
					this.debugLogger.log("Socket was inactive for " + this.inactivityTimeout / 1000 + " seconds. Destroying.");
