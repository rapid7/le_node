...
var _lodash13 = require('lodash.isempty');
...
var Logger = function (_Writable) {
  ...
  function Logger(opts) {
    ...
    if ((0, _lodash10.default)(opts.token)) {
      throw new _error.BadOptionsError(opts, _text2.default.noToken());
    }

    if (!(0, _lodash6.default)(opts.token) || !tokenPattern.test(opts.token)) {
  ...
  (0, _createClass3.default)(Logger, [{
    ...
    value: function log(lvl, _log) {
      ...
      if ((0, _lodash4.default)(modifiedLog)) {
        var safeTime = void 0;
        ...
        if ((0, _lodash14.default)(modifiedLog)) {
          this.emit(errorEvent, new _error.LogentriesError(_text2.default.noLogMessage()));
          return;
        }
    ...
    set: function set(val) {
      if (!(0, _lodash6.default)(val) || !val.length) {
    ...
    set: function set(val) {
      ...
      this._minLevel = (0, _lodash8.default)(num) ? num : 0;
    }
  }, {
    key: 'port',
    get: function get() {
    ...
    set: function set(val) {
      ...
      if ((0, _isInteger2.default)(port) && (0, _lodash2.default)(port, 65536)) this._port = port;
    }
  }, {
    key: 'replacer',
    get: function get() {
    ...
    set: function set(val) {
      this._replacer = (0, _lodash12.default)(val) ? val : undefined;
      this.serialize = (0, _serialize2.default)(this);
    }
  }, {
    ...
    set: function set(val) {
      ...
      if (!(0, _lodash8.default)(this._inactivityTimeout)) {
